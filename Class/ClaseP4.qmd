...
![](graphs/oferts2.png){.absolute top="200" left="0" width="450" height="500"}

![](graphs/oferts1.png){.absolute top="50" right="50" width="450" height="250"}
...
> **E**. Una tormenta arrasa con los campos de cultivo
...
> [ **E**. Una tormenta arrasa con los campos de cultivo]{.alert}

## Pregunta 2{.smaller}

P: ¿Cómo afecta el multiplicador de Uber la cantidad de viajes ofrecidos?

> **A**. Disminuye la cantidad suministrada al aumentar los precios futuros esperados.

> **B**. Disminuye la cantidad suministrada al aumentar los precios de la gasolina.

> **C**. Disminuye la cantidad suministrada al aumentar el número de conductores de Uber disponibles.

> **D**. Aumenta la cantidad suministrada al aumentar el número de conductores de Uber disponibles.

> **E**. Aumenta la cantidad suministrada al cambiar los gustos de los consumidores.
...
> [**D**. Aumenta la cantidad suministrada al aumentar el número de conductores de Uber disponibles.]{.alert}

> **E**. Aumenta la cantidad suministrada al cambiar los gustos de los consumidores.

## Pregunta 3{.smaller}

P: ¿En qué se diferencia el sistema de precios de Uber de los taxis tradicionales?

> **A**. Los precios de Uber son siempre más altos que los de los taxis tradicionales.

> **B**. Los precios de Uber son siempre más bajos que los de los taxis tradicionales.

> **C**. Los precios de Uber se ajustan inmediatamente a los cambios en la demanda, pero los de los taxis tradicionales no.
...
> [**C**. Los precios de Uber se ajustan inmediatamente a los cambios en la demanda, pero los de los taxis tradicionales no.]{.alert}

> **D**. Los precios de Uber no se ajustan inmediatamente a los cambios en la demanda, pero los de los taxis tradicionales sí.

## Otras consideraciones :grinning:
...
::: {.column width="30%"}
**Paso 1:** Aumenta la demanda de viajes (por ejemplo, finaliza un concierto, cierran los bares, se da Año Nuevo, etc.).
:::
::::
...
::: {.column width="30%"}
**Paso 2:** Houston!! tenemos problema. Hay escasez [temporal]{.alert}
:::
::::
...
::: {.column width="30%"}
**Paso 3:** Uber sube precio hasta [equilibrar]{.blur}
:::
::::

# En simultaneo :green_circle:

## Piense en lo siguiente{.smaller}

:::{.fragment}
P: Supongamos que los conductores y los propietarios de gasolineras esperan que los [precios]{.blur} de la gasolina sean más [altos]{.reder} el próximo mes. ¿Cómo afecta el [aumento]{.blur} esperado del [precio de la gasolina]{.bg style="--col: #e64173"} al precio de equilibrio y a la cantidad de gasolina el día anterior al primer día del nuevo mes?
:::

:::{.fragment}
R1: Aumenta la demanda.
*En igualdad de condiciones, el precio de equilibrio y la cantidad aumentan.*
:::

:::{.fragment}
R2: La oferta disminuye.
*En igualdad de condiciones, el precio de equilibrio aumenta y la cantidad disminuye.*
:::

:::{.fragment}
R Final: El precio aumenta sin ambigüedad, pero la cantidad :no_good:
:::
...
## Otro ejemplo{.smaller}

:::{.fragment}
P: Supongamos que un aumento muy publicitado de la contaminación por mercurio [mata]{.alert} al 5% de los [atunes]{.blur} del Pacífico y aviva los temores sobre la exposición al mercurio por comer pescado. [¿Cómo afectan estos cambios al precio de equilibrio y a la cantidad de atún en conserva?]{.reder}
:::

:::{.fragment}
R1: Aumento del precio del insumo --> disminución de la oferta.
*En igualdad de condiciones, el precio de equilibrio aumenta y la cantidad disminuye.*
:::

:::{.fragment}
R2: Cambio en los gustos --> la demanda disminuye.
En igualdad de condiciones, el precio de equilibrio disminuye y la cantidad disminuye.
:::

:::{.fragment}
R Final: La cantidad disminuye sin ambigüedad, pero el precio :warning:.
:::
...
:::{.incremental}
- Los desplazamientos se dan por muchos [factores]{.bg style="--col: #FFFF00"}
- Los [precios]{.alert} se modifican hasta un punto de regresar al equilibrio (incluso a uno nuevo)
- Los mercados no son [perfectos]{.alert}, sin embargo interactuan muy bien las fuerzas de oferta y demanda
:::

# Fin... {background-color="#006dae"}
